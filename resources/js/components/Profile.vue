  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="card card-widget widget-user">
       ...
       <div class="col-md-12 mt-7" style="margin-top:60px;">
            <div class="card">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" @change="uploadingProfile" class="form-control" id="inputSkills">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Passport (leave empty if not changing)</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" v-model="form.password" id="inputSkills" placeholder="Skills">
                        </div>
                    </div>
    ...
    uploadingProfile(event) {
      ...
      if (file["size"] < 2000000) {
        ...
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "Image Can Not Be More Than 2MB",
        });
      }
    },
    loadProfile() {
